	...
	<app-layout>
		<div class="col-12 mt-2">
			<div class="card">
				...
				<div class="card-body">
					<h6 class="card-title text-dark text-gradient">Lista de Historias</h6>
					<div class="row">
								...
								<tr v-for="mascota in mascotas.data" :key="mascota.id_masc">
									...
									<td class="text-sm">
										<div class="d-flex justify-content-center align-items-center">
											<Link :href="route('historias.show', mascota.id_masc)" class="btn btn-icon-only btn-rounded btn-outline-info mb-0 me-2 btn-md d-flex align-items-center justify-content-center" data-bs-toggle="tooltip" data-bs-original-title="Mostrar">
...
export default {
	...
	watch: {
		params: {
			handler() {
				this.$inertia.get(this.route('historias.index'), this.params, { replace: true, preserveState: true });
			},
			deep: true,
		},
	},
