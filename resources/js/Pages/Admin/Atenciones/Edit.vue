				...
				<div class="card mt-4">
					<form role="form" @submit.prevent="submit" class="needs-validation">
						<div class="card-header">
							<h5 class="mb-0">Editar Atención</h5>
						</div>
							...
							<div class="row">
								<div class="col-md-4">
									<div class="input-group input-group-static"
										...
										<select v-model="form.id_masc" class="form-control" id="mascota" autofocus>
...
export default {
	...
	data() {
		return {
			form: useForm({
				fech_aten: this.atencion.fech_aten,
				tipo_aten: this.atencion.tipo_aten,
				peso_aten: this.atencion.peso_aten,
				temp_aten: this.atencion.temp_aten,
				descrip_aten: this.atencion.descrip_aten,
				obtencion_masc: this.atencion.obtencion_masc,
				id_masc: this.atencion.id_masc,
			}),
		}
	},
	...
	methods: {
		submit() {
            this.form.put(route('atenciones.update', this.atencion.id_aten), {
