					...
					<form role="form" @submit.prevent="submit" class="needs-validation">
						...
						<div class="card-body pt-0">
							...
							<div class="row mt-4 py-4 bg-light">
								...
								<div class="col-md-4">
									<div class="input-group input-group-static"
										:class="{ 'is-invalid': errors.contrasena_per }">
										<label>Contraseña</label>
										<input type="password"
											class="form-control"
											v-model="form.contrasena_per"
											placeholder="Contraseña">
										<div v-if="errors.contrasena_per" class="invalid-feedback">{{ errors.contrasena_per }}</div>
									</div>
								</div>
								<div class="col-md-4">
									<div class="input-group input-group-static"
										:class="{ 'is-invalid': errors.contrasena_per_confirmation }">
										<label>Confirmar Contraseña</label>
										<input type="password"
											class="form-control"
											v-model="form.contrasena_per_confirmation"
											placeholder="Contraseña">
										<div v-if="errors.contrasena_per_confirmation" class="invalid-feedback">{{ errors.contrasena_per_confirmation }}</div>
									</div>
								</div>
							</div>
							<div class="row mt-4">
						...
						<div class="card-footer">
							<div class="row">
								<div class="col-lg-8 col-12 actions text-end ms-auto">
									<Link :href="route('usuarios.index')" class="btn btn-outline-dark mb-0">Cancelar</Link>
