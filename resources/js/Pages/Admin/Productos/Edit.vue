...
export default {
	...
	data() {
		return {
			form: useForm({
				numserie_pro: this.producto.numserie_pro,
				nom_pro: this.producto.nom_pro,
				fecven_pro: this.producto.fecven_pro,
				cantidad_pro: this.producto.cantidad_pro,
				precio_pro: this.producto.precio_pro,
			}),
		}
	},
	...
	methods: {
		submit() {
            this.form.put(route('productos.update', this.producto.id_pro), {
