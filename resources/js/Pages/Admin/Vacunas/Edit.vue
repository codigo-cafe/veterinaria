				...
				<div class="card mt-4">
					<form role="form" @submit.prevent="submit" class="needs-validation">
						<div class="card-header">
							<h5 class="mb-0">Editar Vacuna</h5>
						</div>
...
export default {
	...
	data() {
		return {
			form: useForm({
				nom_vac: this.vacuna.nom_vac,
				dosis_vac: this.vacuna.dosis_vac,
				fecapl_vac: this.vacuna.fecapl_vac,
				fecprox_vac: this.vacuna.fecprox_vac,
				id_masc: this.vacuna.id_masc,
			}),
		}
	},
	...
	methods: {
		submit() {
            this.form.put(route('vacunas.update', this.vacuna.id_vac), {
